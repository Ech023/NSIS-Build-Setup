...
!define APP_DISPLAY_NAME "APPLauncher"      ; 显示名称（用于界面、快捷方式）
!define APP_NAME         "SourceGit"        ; 程序名称（用于文件名、注册表键）
...
!define APP_PUBLISHER    "SourceGit-SCM"    ; 组织
!define APP_WEBSITE      "https://github.com/sourcegit-scm/sourcegit" ; 组织网站
...
Icon "app.ico"                         ; 请将 app.ico 放在脚本同目录
...
!insertmacro MUI_PAGE_LICENSE "LICENSE.txt"; 保存格式为 utf-8 Bom 不然可能显示乱码
